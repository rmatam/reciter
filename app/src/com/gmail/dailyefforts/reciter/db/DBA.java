...
package com.gmail.dailyefforts.reciter.db;
...
public class DBA extends SQLiteOpenHelper {
    ...
    public static final String TABLE_WORD_LIST_LITERATURE = "literature";
    ...
    public static final String TABLE_TEST_REPORT_LITERATURE = "testreport_literature";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(getCreateWordListSql(TABLE_WORD_LIST_LITERATURE));
        ...
        db.execSQL(getCreateTestTableSql(TABLE_TEST_REPORT_LITERATURE));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_TEST_REPORT_LITERATURE);
        onCreate(db);
    }
